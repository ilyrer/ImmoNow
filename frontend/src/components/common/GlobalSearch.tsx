    ...
    <div ref={searchRef} className={`relative ${className}`}>
      ...
      <div className={`relative ${compact ? 'w-64' : 'w-full max-w-2xl'}`}>
        ...
        <input
          ...
          className={`block w-full pl-10 pr-4 py-2 border border-gray-300 dark:border-gray-600 rounded-lg bg-white dark:bg-gray-800 text-gray-900 dark:text-white placeholder-gray-500 dark:placeholder-gray-400 focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-transparent ${compact ? 'text-sm' : ''}`}
        />
        {query && (
          <button
            onClick={() => {
