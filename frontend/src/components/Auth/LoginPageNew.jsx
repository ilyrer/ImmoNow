      ...
      <div className="relative z-10 min-h-screen flex">
        ...
        >
          ...
          >
            {/* Glass Card */}
            <motion.div 
              className="backdrop-blur-3xl bg-white/5 border border-white/10 rounded-3xl p-8 shadow-2xl relative overflow-hidden"
            ...
            >
              ...
              <div className="relative z-10">
                ...
                >
                  <h2 className="text-3xl font-bold bg-gradient-to-r from-white via-purple-200 to-white bg-clip-text text-transparent mb-2">
                ...
                <motion.div 
                  variants={itemVariants}
                  className="flex bg-white/5 backdrop-blur-xl rounded-2xl p-1 mb-8 border border-white/10"
                >
                  <motion.button
                    type="button"
                ...
                <form onSubmit={handleSubmit} className="space-y-6">
                      ...
                      >
                        ...
                        <div className="relative">
                          <input
                            ...
                            className={`w-full px-4 py-3 bg-white/5 border rounded-xl text-white placeholder-purple-300/50 focus:bg-white/10 transition-all duration-300 backdrop-blur-xl ${
                              focusedField === 'name' ? 'border-purple-400/50' : 'border-white/10'
                            }`}
                  ...
                  <motion.div variants={itemVariants}>
                    ...
                    <div className="relative">
                      <input
                        ...
                        onBlur={() => setFocusedField(null)}
                        className={`w-full px-4 py-3 bg-white/5 border rounded-xl text-white placeholder-purple-300/50 focus:bg-white/10 transition-all duration-300 backdrop-blur-xl ${
                          focusedField === 'email' ? 'border-purple-400/50' : 'border-white/10'
                        }`}
                  ...
                  <motion.div variants={itemVariants}>
                    ...
                    <div className="relative">
                      <input
                        ...
                        onBlur={() => setFocusedField(null)}
                        className={`w-full px-4 py-3 pr-12 bg-white/5 border rounded-xl text-white placeholder-purple-300/50 focus:bg-white/10 transition-all duration-300 backdrop-blur-xl ${
                          focusedField === 'password' ? 'border-purple-400/50' : 'border-white/10'
                        }`}
                        ...
                        >
                          ...
                          <div className="relative">
                            <input
                              ...
                              onBlur={() => setFocusedField(null)}
                              className={`w-full px-4 py-3 pr-12 bg-white/5 border rounded-xl text-white placeholder-purple-300/50 focus:bg-white/10 transition-all duration-300 backdrop-blur-xl ${
                                focusedField === 'confirmPassword' ? 'border-purple-400/50' : 'border-white/10'
                              }`}
                        ...
                        >
                          ...
                          <div className="relative">
                            <input
                              ...
                              onBlur={() => setFocusedField(null)}
                              className={`w-full px-4 py-3 bg-white/5 border rounded-xl text-white placeholder-purple-300/50 focus:bg-white/10 transition-all duration-300 backdrop-blur-xl ${
                                focusedField === 'company' ? 'border-purple-400/50' : 'border-white/10'
                              }`}
                  ...
                  <motion.button
                    ...
                    className="w-full relative overflow-hidden bg-gradient-to-r from-purple-600 via-pink-600 to-purple-700 text-white py-4 px-8 rounded-xl font-semibold text-lg shadow-2xl disabled:opacity-50 disabled:cursor-not-allowed focus:outline-none group"
                    whileHover={{ 
                      scale: 1.02, 
                    ...
                    <div className="grid grid-cols-3 gap-3 mt-6">
                      {[
                        ...
                        <motion.button
                          ...
                          className="bg-white/5 backdrop-blur-xl border border-white/10 rounded-xl py-3 px-4 text-sm font-medium text-white hover:bg-white/10 transition-all duration-300 focus:outline-none"
