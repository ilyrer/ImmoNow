          ...
          <div className="bg-white/20 dark:bg-white/5 backdrop-blur-xl border border-white/20 dark:border-white/10 rounded-2xl shadow-glass overflow-hidden">
            ...
            <div className="p-6 space-y-4">
              {commissionTargets.map((target, index) => (
                <div key={index} className="bg-white/20 dark:bg-white/5 backdrop-blur-sm border border-white/20 dark:border-white/10 rounded-xl p-4 shadow-glass-sm hover:shadow-glass hover:bg-white/30 dark:hover:bg-white/10 transition-all duration-200">
                  <div className="flex items-center justify-between">
                    <div className="flex items-center space-x-3">
      ...
      {selectedView === 'forecast' && (
        <div className="space-y-6">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
            <div className="bg-white/20 dark:bg-white/5 backdrop-blur-xl border border-white/20 dark:border-white/10 rounded-2xl shadow-glass p-6 hover:shadow-glass-lg hover:bg-white/30 dark:hover:bg-white/10 transition-all duration-300">
        ...
        <div className="space-y-6">
          ...
          <div className="bg-white/20 dark:bg-white/5 backdrop-blur-xl border border-white/20 dark:border-white/10 rounded-2xl shadow-glass overflow-hidden">
            ...
            <div className="p-6 space-y-6">
              {pipelineStages.map((stage, index) => {
                ...
                return (
                  <div key={index} className="bg-white/10 dark:bg-white/5 backdrop-blur-sm border border-white/20 dark:border-white/10 rounded-xl p-4 shadow-glass-sm hover:shadow-glass hover:bg-white/20 dark:hover:bg-white/10 transition-all duration-200">
                    ...
                    <div className="w-full bg-white/20 dark:bg-white/5 rounded-full h-3 mb-2 shadow-glass-sm">
                      <div 
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
            ...
            <div className="bg-white/20 dark:bg-white/5 backdrop-blur-xl border border-white/20 dark:border-white/10 rounded-2xl shadow-glass overflow-hidden">
              ...
              <div className="p-6 space-y-4">
                <div className="bg-white/20 dark:bg-white/5 backdrop-blur-sm border border-white/20 dark:border-white/10 rounded-xl p-4 shadow-glass-sm">
                  <div className="flex items-center justify-between">
