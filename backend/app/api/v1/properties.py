...
async def get_properties(
    ...
    living_area_min: Optional[int] = Query(None, description="Minimum living area filter"),
    living_area_max: Optional[int] = Query(None, description="Maximum living area filter"),
    ...
    year_built_min: Optional[int] = Query(None, description="Minimum year built filter"),
    year_built_max: Optional[int] = Query(None, description="Maximum year built filter"),
