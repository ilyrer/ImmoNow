...
class InvestorPortfolio(models.Model):
    ...
    tenant = models.ForeignKey(
        Tenant, on_delete=models.CASCADE, related_name="investor_portfolios"
    )
...
class Investment(models.Model):
    ...
    id = models.UUIDField(primary_key=True, default=uuid.uuid4, editable=False)
    tenant = models.ForeignKey(
        Tenant, on_delete=models.CASCADE, related_name="investments"
    )
...
class InvestorReport(models.Model):
    ...
    id = models.UUIDField(primary_key=True, default=uuid.uuid4, editable=False)
    tenant = models.ForeignKey(
        Tenant, on_delete=models.CASCADE, related_name="investor_reports"
    )
    portfolio = models.ForeignKey(
        InvestorPortfolio,
        on_delete=models.CASCADE,
...
class MarketplacePackage(models.Model):
    ...
    id = models.UUIDField(primary_key=True, default=uuid.uuid4, editable=False)
    tenant = models.ForeignKey(
        Tenant, on_delete=models.CASCADE, related_name="marketplace_packages"
    )
...
class PackageReservation(models.Model):
    ...
    investor = models.ForeignKey(
        User, on_delete=models.CASCADE, related_name="package_reservations"
    )
