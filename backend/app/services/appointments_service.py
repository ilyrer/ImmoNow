...
class AppointmentsService:
    ...
    async def get_appointments(
        ...
        appointments, total = await get_appointments_sync()
    ...
    async def get_appointment(self, appointment_id: str) -> Optional[AppointmentResponse]:
        ...
        @sync_to_async
        def get_appointment_sync():
            try:
                return Appointment.objects.get(id=appointment_id, tenant_id=self.tenant_id)
            except Appointment.DoesNotExist:
                return None
        
        appointment = await get_appointment_sync()
        if appointment:
    ...
    async def create_appointment(
        ...
        appointment = await create_appointment_sync()
        return await self._build_appointment_response(appointment)
    ...
    async def update_appointment(
        ...
        appointment = await update_appointment_sync()
        if appointment:
            return await self._build_appointment_response(appointment)
        return None
