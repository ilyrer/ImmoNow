"""
Immowelt Service
Real service for publishing properties to Immowelt
"""
...
class ImmoweltService:
    """Service for Immowelt integration"""
    
    def __init__(self, tenant_id: str):
        self.tenant_id = tenant_id
        self.oauth_service = ImmoweltOAuthService(tenant_id)
    ...
    async def get_access_token(self) -> Optional[str]:
        ...
        def get_token():
            try:
                ...
                if settings.immowelt_api_key:
                    try:
                        token_data = json.loads(settings.immowelt_api_key)
                        ...
                        if expires_at > datetime.utcnow():
                            ...
                            try:
                                refreshed_data = self.oauth_service.refresh_access_token(token_data['refresh_token'])
                                ...
                                settings.immowelt_api_key = json.dumps({
                                    ...
                                    'expires_at': refreshed_data['expires_at'].isoformat()
                                })
                                settings.save()
