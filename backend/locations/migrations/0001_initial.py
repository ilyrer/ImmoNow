        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    ...
                    models.CharField(
                        blank=True,
                        help_text="State/Bundesland (e.g., Bayern, Berlin)",
                        max_length=100,
                    ),
                ),
                (
                    "country",
                    models.CharField(
                        default="Deutschland", help_text="Country name", max_length=100
                    ),
                ),
                (
                    "postal_code_start",
                ...
                (
                    ...
                    models.CharField(
                        blank=True,
                        help_text="End of postal code range (e.g., 81999)",
                        max_length=10,
                    ),
                ),
                (
            ...
            options={
                ...
                "indexes": [
                    models.Index(
                        fields=["city", "is_active"], name="location_ma_city_9bf1d3_idx"
                    ),
                    models.Index(
                        fields=["postal_code_start", "postal_code_end"],
                        name="location_ma_postal__ac65e1_idx",
                    ),
                    models.Index(
                        fields=["-population"], name="location_ma_populat_39466b_idx"
                    ),
                ],
            },
        ),
