...
class AutomationRule(models.Model):
    ...
    tenant = models.ForeignKey('accounts.Tenant', on_delete=models.CASCADE, related_name="automation_rules")
    ...
    created_by = models.ForeignKey(
        'accounts.User', on_delete=models.CASCADE, related_name="created_automations", blank=True, null=True
    )
...
class AutomationLog(models.Model):
    ...
    tenant = models.ForeignKey('accounts.Tenant', on_delete=models.CASCADE, related_name="automation_logs")
