...
class SLA(models.Model):
    ...
    tenant = models.ForeignKey('accounts.Tenant', on_delete=models.CASCADE, related_name="slas")
    ...
    created_by = models.ForeignKey(
        'accounts.User', on_delete=models.CASCADE, related_name="created_slas", blank=True, null=True
    )
...
class SLAInstance(models.Model):
    ...
    task = models.ForeignKey('tasks.Task', on_delete=models.CASCADE, related_name="sla_instances")
    tenant = models.ForeignKey('accounts.Tenant', on_delete=models.CASCADE, related_name="sla_instances")
