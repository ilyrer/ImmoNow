...
SECRET_KEY = os.getenv("SECRET_KEY", "django-insecure-k4_yt(x@5)+^h!yh+(9jw-h#j5va)r%ph!@wl1f02yx)3v_lq4")
...
MIDDLEWARE = [
    ...
    "app.core.tenant_middleware.TenantMiddleware",  # Tenant-aware Middleware
...
# Optional: Use PostgreSQL if environment variables are set
